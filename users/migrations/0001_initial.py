    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, null=True, upload_to=users.models.generate_unique_filename)),
                ...
                ('user_type', models.CharField(blank=True, choices=[('TRAINER', 'trainer'), ('CLIENT', 'client'), ('ADMIN', 'admin')], max_length=30, null=True)),
